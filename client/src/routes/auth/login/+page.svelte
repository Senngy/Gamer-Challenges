<script>
	...
	import { validateLoginData, sanitizeLoginData } from '$lib/utils/validation.form.login.js'; // Importation des fonctions de validation
	...
	// Fonction pour gérer la soumission du formulaire et la connexion
...
<svelte:head>
	...
	<meta
		name="description"
		content="Connectez-vous à votre compte GamerChallenges pour accéder à vos défis gaming et rejoindre la communauté."
	/>
